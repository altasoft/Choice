...
public sealed class SourceCodeBuilder
{
    ...
    public SourceCodeBuilder AppendSummary(string summary) => AppendBlock("summary", summary);
    ...
    /// <param name="parameterDescription">The description of the parameter.</param>
    /// <returns>A reference to this <see cref="SourceCodeBuilder"/> instance.</returns>
    public SourceCodeBuilder AppendTypeParamDescription(string parameterName, string parameterDescription)
    {
        Append("/// <typeparam name=\"").Append(parameterName).Append("\">").Append(parameterDescription).AppendLine("</typeparam>");
        return this;
    }
    ...
    /// <returns>A reference to this <see cref="SourceCodeBuilder"/> instance.</returns>
    public SourceCodeBuilder AppendBlock(string block, string line)
    {
