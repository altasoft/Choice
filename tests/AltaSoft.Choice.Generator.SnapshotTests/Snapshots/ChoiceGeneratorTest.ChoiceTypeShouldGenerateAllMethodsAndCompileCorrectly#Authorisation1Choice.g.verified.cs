...
public sealed partial class Authorisation1Choice : IXmlSerializable
{
    ...
    private static readonly XmlSerializer s_codeSerializer = new (typeof(TestNamespace.Authorisation1Code), new XmlRootAttribute("Code"));
    ...
    public void ReadXml(XmlReader reader)
    {
        ...
        while (reader.MoveToContent() == XmlNodeType.Element)
        {
            ...
            {
                case "Code":
                    Code = (TestNamespace.Authorisation1Code)(s_codeSerializer.Deserialize(reader) ?? throw new XmlException(" The value of Code cannot be null"));
                    sawChoice = true;
                    break;
